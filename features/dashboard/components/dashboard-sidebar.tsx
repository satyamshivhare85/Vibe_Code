...
interface PlaygroundData {
  ...
  starred: boolean  // anpne playground mark as starred kr rkha hai ki nhi
}

// Map icon names (strings) to their corresponding LucideIcon components and map according to this
...
//we have initaally playground data.tsx
    ...
    <Sidebar variant="inset" collapsible="icon" className="border-1 border-r">
      <SidebarHeader>
        <div className="flex items-center gap-2 px-4 py-3 justify-center">
          <Image src={"/login.svg"} alt="login" height={60} width={60} />
        </div>
