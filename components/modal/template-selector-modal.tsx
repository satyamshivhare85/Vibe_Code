...
//template options with additional metadata for better filtering and display    
interface TemplateOption {
  ...
  icon: string;
  color: string;
  popularity: number;  //abhi hard coded hai but we can make it dynamic based on user feedback and usage data
  tags: string[];
  features: string[];
  ...
  return (
    ...
    >
      <DialogContent className="sm:max-w-[800px] max-h-[90vh] overflow-y-auto">
        ...
        {/*  we are rendering two forms one is of template selection and one is for configuration */}
        {step === "select" ? (
          <>
            <DialogHeader>
